...
tap.test('badge logic - total date metrics', function (t) {
  ...
  t.deepEqual(totalDateCheck(userWithTierOneBadges),
    {yearlongmapper: {category: 15, level: 1}}, 'a user with 25-49 unique dates should return {yearlongmapper: 1}');

  t.deepEqual(totalDateCheck(userWithTierTwoBadges),
    {yearlongmapper: {category: 15, level: 2}}, 'a user with 50-99 sequential dates should return {yearlongmapper: 2}');

  t.deepEqual(totalDateCheck(userWithTierThreeBadges),
    {yearlongmapper: {category: 15, level: 3}}, 'a user with 100+ sequential dates should return {yearlongmapper: 3}');
