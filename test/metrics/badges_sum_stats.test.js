...
const sumCheck = require("../../src/badges/sum_check");
const sumStats = require("../fixtures/badges/sum_stats.json");

const userWithNoBadges = sumStats.user_with_no_badges;
const userWithTierOneBadges = sumStats.user_with_tier1_badges;
const userWithTierTwoBadges = sumStats.user_with_tier2_badges;
const userWithTierThreeBadges = sumStats.user_with_tier3_badges;

// note: road counts and road mod counts were removed
tap.test("badge logic - sum metrics", t => {
  t.deepEqual(
    sumCheck(userWithNoBadges),
    {},
    "a user with all <level 1 metrics should return an empty object"
  );

  t.deepEqual(
    sumCheck(userWithTierOneBadges),
    {
  ...
  t.deepEqual(
    sumCheck(userWithTierTwoBadges),
    {
  ...
  t.deepEqual(
    sumCheck(userWithTierThreeBadges),
    {
